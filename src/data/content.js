...
export const whyChooseUs = [
  ...
  { title: 'Pan-India Delivery', detail: 'Garden products, pots, seeds and tools shipped nationwide via mystargardens.com.', icon: 'Truck' },
]

// Full plant catalogue as listed on the original site
export const plants = [
  { name: 'Money Plant Marble', sci: 'Epipremnum aureum', category: 'Air-Purifying', desc: 'Variegated leaves with a mix of green and white or cream patterns, suited for indoor environments.' },
  { name: 'Syngonium Green', sci: 'Syngonium podophyllum', category: 'Foliage', desc: 'Also called Arrowhead Plant — heart-shaped leaves that start light green and deepen as they mature.' },
  { name: 'Areca Palm', sci: 'Dypsis lutescens', category: 'Foliage', desc: 'Feathery, arching fronds with a tropical appearance; native to Madagascar.' },
  { name: 'Rubber Plant Black', sci: "Ficus elastica 'Black Prince'", category: 'Foliage', desc: 'Dark, almost black-purple leaves with a glossy finish.' },
  { name: 'Aglaonema Pink Lipstick', sci: 'Aglaonema commutatum', category: 'Foliage', desc: 'Bold pink, red and green hues create a distinctive appearance in any space.' },
  { name: 'Money Plant Green', sci: 'Epipremnum aureum', category: 'Air-Purifying', desc: 'Well known for air-purifying properties, removing toxins like formaldehyde and benzene.' },
  { name: 'Snake Plant', sci: 'Dracaena trifasciata', category: 'Air-Purifying', desc: "Also called Mother-in-Law's Tongue — hardy, low-maintenance, releases oxygen at night." },
  { name: 'Zamia Calcus', sci: 'Zamia furfuracea', category: 'Foliage', desc: 'Cycad with stiff, dark green, feather-like leaves in a rosette pattern; native to tropical Americas.' },
  { name: 'Fiddle Leaf Fig', sci: 'Ficus lyrata', category: 'Foliage', desc: 'Large, glossy, violin-shaped leaves that create a bold, modern statement; filters air pollutants.' },
  { name: 'Philodendron', sci: 'Philodendron spp.', category: 'Air-Purifying', desc: 'Vining and upright varieties with lush green foliage and strong air-purifying qualities.' },
  { name: 'Anthurium Red', sci: 'Anthurium andraeanum', category: 'Flowering', desc: 'Glossy, heart-shaped red flowers and dark green leaves; symbolises hospitality and good luck.' },
  { name: 'Song of India', sci: 'Dracaena reflexa', category: 'Air-Purifying', desc: 'Long, narrow leaves — green with yellow edges; known for air-purifying abilities.' },
  { name: 'Philodendron Red Congo', sci: 'Philodendron tatei', category: 'Foliage', desc: 'Self-supporting plant with large, deep green leaves that emerge red.' },
  { name: 'Aglaonema Pink', sci: 'Aglaonema commutatum', category: 'Foliage', desc: 'Vibrant indoor plant with striking pink and green leaves; helps filter indoor pollutants.' },
  { name: 'Dracaena Massangeana', sci: 'Dracaena fragrans', category: 'Air-Purifying', desc: 'Tall, cane-like plant with long green leaves featuring a yellow stripe.' },
  { name: 'Parrotline', sci: 'Epipremnum aureum', category: 'Air-Purifying', desc: 'Fast-growing, easy-care Money Plant variety with bright variegation resembling parrot colours.' },
  { name: 'Rain Lily', sci: 'Zephyranthes spp.', category: 'Flowering', desc: 'Blooms suddenly after rain with dainty pink, white or yellow flowers; symbolises renewal.' },
  { name: 'Syngonium Pink', sci: 'Syngonium podophyllum', category: 'Foliage', desc: 'Stunning pink and green variegated leaves add colour to indoor spaces.' },
  { name: 'Aglaonema', sci: 'Aglaonema commutatum', category: 'Foliage', desc: 'Also called Chinese Evergreen — patterns including green, silver and red hues.' },
  { name: 'Golden Dracaena', sci: 'Dracaena fragrans', category: 'Foliage', desc: 'Also called Corn Plant — dark green leaves with yellow/gold streaks; thrives in low light.' },
  { name: 'Rubber Plant Variegated', sci: 'Ficus elastica', category: 'Foliage', desc: 'Multi-coloured foliage mixing green, white, cream, and sometimes pink or yellow.' },
  { name: 'Peace Lily', sci: 'Spathiphyllum spp.', category: 'Air-Purifying', desc: 'Beautiful white flowers and lush green foliage; easy to care for.' },
  { name: 'Money Plant Gold', sci: 'Epipremnum aureum', category: 'Air-Purifying', desc: 'Vibrant green and golden-yellow variegated leaves; symbolises prosperity.' },
  { name: 'Chinese Doll', sci: 'Radermachera sinica', category: 'Foliage', desc: 'Ornamental houseplant with delicate, glossy, dark green leaves and a tree-like appearance.' },
  { name: 'Aglaonema Ice Plant', sci: 'Aglaonema commutatum', category: 'Foliage', desc: 'Striking silver-green foliage gives an elegant, frosty appearance; tolerates low light.' },
  { name: 'Aralia', sci: 'Polyscias spp.', category: 'Air-Purifying', desc: 'Feathery, finely divided leaves or broad glossy foliage; improves air quality by filtering toxins.' },
  { name: 'Monstera', sci: 'Monstera deliciosa', category: 'Foliage', desc: 'Large, split leaves giving a unique, jungle-like appearance.' },
  { name: 'Schefflera', sci: 'Schefflera arboricola', category: 'Air-Purifying', desc: 'Called the Umbrella Plant — glossy green leaves arranged like an umbrella; purifies air.' },
  { name: 'Philodendron Green Congo', sci: 'Philodendron tatei', category: 'Foliage', desc: 'Lush, upright-growing plant with broad, glossy green leaves in a compact, bushy form.' },
  { name: 'Money Plant Variegated', sci: 'Epipremnum aureum', category: 'Air-Purifying', desc: 'Fast-growing vine with heart-shaped, white-and-yellow variegated leaves.' },
  { name: 'Dieffenbachia', sci: 'Dieffenbachia seguine', category: 'Foliage', desc: 'Large, variegated green and cream-coloured leaves; toxic if ingested.' },
  { name: 'Anthurium White', sci: 'Anthurium andraeanum', category: 'Flowering', desc: 'Glossy white blooms and deep green foliage; symbolises peace and elegance.' },
  { name: 'Geranium', sci: 'Pelargonium spp.', category: 'Flowering', desc: 'Colourful flowering plants with pink, red or white blooms from spring to early autumn.' },
