  ...
  return (
    <DialogPrimitive.Root>
      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed inset-x-0 bottom-0 z-50 flex max-h-[90dvh] flex-col overflow-hidden rounded-t-2xl bg-surface shadow-2xl lg:hidden">
