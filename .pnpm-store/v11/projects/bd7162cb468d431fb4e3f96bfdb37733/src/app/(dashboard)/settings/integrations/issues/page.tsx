...
export default async function IntegrationIssuesPage() {
  ...
  return (
    <>
      <div className="mb-2"><Link href="/settings/integrations" className="inline-flex items-center gap-1.5 text-sm font-medium text-ink-muted hover:text-ink"><LuArrowLeft className="size-4" />Integrations</Link></div>
