...
export default async function UsersPage() {
  ...
  const [staff, invites, requests, business] = await Promise.all([
  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        <Card><CardHeader title="Staff" description="Role changes and deactivation are blocked until active work is reassigned." />{staff.length === 0 ? <EmptyState title="No staff accounts" /> : <StaffDirectory staff={staff} bdmEnabled={business.bdmRoleEnabled} />}</Card>
